...
public class DynamicBeat extends JFrame {
	...
	private Image Background = new ImageIcon(Main.class.getResource("../images/introBackground(Title).jpg"))
			.getImage();//introBackgroud->Background로 변경한 이유는 Background인스턴스를 대기화면 배경과 게임화면 배경 모두 담을 변수처럼 사용하기 위해서 리소스만 다르게 할뿐임
	private Image selectedImage = new ImageIcon(Main.class.getResource("../images/Mighty Love Start Image.png"))
			.getImage();//선택된 게임 화면 인스턴스
	...
	public DynamicBeat() {
		...
		Music introMusic = new Music("flow-211881.mp3", true);
		introMusic.start();
	}
